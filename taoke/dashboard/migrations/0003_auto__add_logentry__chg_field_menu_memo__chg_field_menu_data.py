...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('dashboard', ['LogEntry'])


        # Changing field 'Menu.memo'
        db.alter_column('dashboard_menu', 'memo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Menu.data'
        db.alter_column('dashboard_menu', 'data', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'LogEntry'
        db.delete_table('django_admin_log')


        # Changing field 'Menu.memo'
        db.alter_column('dashboard_menu', 'memo', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Menu.data'
        db.alter_column('dashboard_menu', 'data', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'dashboard.logentry': {
            'Meta': {'ordering': "('-action_time',)", 'object_name': 'LogEntry', 'db_table': "'django_admin_log'"},
        ...
        'dashboard.menu': {
            ...
            'data': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
