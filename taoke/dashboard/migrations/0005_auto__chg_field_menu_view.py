...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Menu.view'
        db.alter_column('dashboard_menu', 'view', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Menu.view'
        db.alter_column('dashboard_menu', 'view', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
